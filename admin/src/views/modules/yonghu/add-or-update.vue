	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"20px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="密码错误次数" prop="passwordwrongnum">
					<el-input v-model.number="ruleForm.passwordwrongnum" placeholder="密码错误次数" clearable  :readonly="ro.passwordwrongnum"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' v-else class="input" label="密码错误次数" prop="passwordwrongnum">
...
export default {
    ...
    onSubmit() {
      ...
      if((this.ruleForm.yonghuzhanghao.length>13)){
