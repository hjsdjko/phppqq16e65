<template>
  <div :style='{"minHeight":"calc(100vh - 200px)","padding":"20px 0 30px","margin":"0 auto","color":"#666","background":"none","width":"calc(100% - 60px)","fontSize":"14px","height":"100%"}'>
    <el-form
      ...
      label-width="200px"
    >
      <el-form-item :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}' label="选择试卷名称" prop="paperid">
