<template>
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20240219/27a0fc954b6c4ea3818b7a5782e990e1.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"0px solid #f6f6f6","minHeight":"1000px","padding":"0px 20px 20px","boxShadow":"0 0px 0px rgba(0, 0, 0, .2)","margin":"0 auto","borderRadius":"0px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240219/55b37622e3504c2c9ffff7b52bc49a5c.png) no-repeat 64% 240px,url(http://codegen.caihongy.cn/20230811/35998be3b95844a68cab0b7410497ea1.png) no-repeat center top / 100% 100%","width":"40%","fontSize":"16px","position":"relative","height":"auto"}'>
        <div v-if="true" :style='{"padding":"0px","margin":"180px auto 230px","borderColor":"#ddd","color":"#333","background":"none","borderWidth":"0px","display":"inline-block","width":"80%","lineHeight":"auto","fontSize":"26px","borderStyle":"solid","fontWeight":"600"}' class="title-container">基于WAMP的行政职业能力测试系统的设计与实现登录</div>
        ...
        <div :style='{"margin":"20px auto 0","alignItems":"center","flexWrap":"wrap","display":"flex","width":"50%","fontSize":"16px","position":"relative","justifyContent":"flex-start"}'>
          <el-button v-if="loginType==1" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 0 0 20px","margin":"0 0 20px","color":"#fff","textAlign":"center","letterSpacing":"10px","outline":"none","borderRadius":"10px","background":"#b3d8fc","width":"100%","fontSize":"20px","height":"50px"}' type="primary" @click="login()" class="loginInBt">登录</el-button>
	...
	setVerify() {
		...
		this.$nextTick(() => {
			$('#option1').slideVerify({
				...
				vSpace: 5, //间隔
				imgName: [{"name":"01.jpg","uid":1691997808786,"url":"http://codegen.caihongy.cn/20230814/cda73d23dee6436cb326c3e2db8780a5.jpg","status":"success"},{"name":"02.jpg","uid":1691997811473,"url":"http://codegen.caihongy.cn/20230814/cfe7e2ce89c24087947f20076f6b9cdf.jpg","status":"success"},{"name":"03.jpg","uid":1691997814476,"url":"http://codegen.caihongy.cn/20230814/c97f09bd3bb04e0c8833c6b9795d2528.jpg","status":"success"}].map((item)=>{return item.url}),
...
.container {
  ...
  background-size: cover;
      background: url(http://codegen.caihongy.cn/20240219/27a0fc954b6c4ea3818b7a5782e990e1.jpg);
