<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20240219/27a0fc954b6c4ea3818b7a5782e990e1.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":"0px solid #f6f6f6","minHeight":"1000px","padding":"0px 20px 90px","boxShadow":"0 0px 0px rgba(0, 0, 0, .2)","margin":"0 auto","borderRadius":"0px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240219/55b37622e3504c2c9ffff7b52bc49a5c.png) no-repeat 64% 280px,url(http://codegen.caihongy.cn/20230811/35998be3b95844a68cab0b7410497ea1.png) no-repeat center top / 100% 100%","width":"40%","fontSize":"16px","position":"relative","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"padding":"0px","margin":"220px auto 230px","borderColor":"#eee","color":"#333","background":"none","borderWidth":"0px","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"26px","borderStyle":"solid","fontWeight":"600"}' class="title">基于WAMP的行政职业能力测试系统的设计与实现注册</div>
				...
				<button :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 0 0 30px","boxShadow":"0 0 0px rgba(64, 158, 255, .5)","margin":"30px auto 5px","color":"#fff","display":"block","letterSpacing":"10px","outline":"none","borderRadius":"10px","background":"#b3d8fc","width":"50%","fontSize":"20px","height":"44px"}' type="button" class="r-btn" @click="login()">注册</button>
	...
	methods: {
		...
		login() {
			var url=this.tableName+"/register";
					...
					if(this.ruleForm.yonghuzhanghao && (this.ruleForm.yonghuzhanghao.length>13) && `yonghu` == this.tableName){
					...
					if(this.ruleForm.mima && (this.ruleForm.mima.length>13) && `yonghu` == this.tableName){
