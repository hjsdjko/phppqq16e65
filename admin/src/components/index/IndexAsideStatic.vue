...
<style lang="scss" scoped>
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 /deep/ .el-submenu.other .el-menu {
				...
				padding: 0px 0 0;
				margin: 10px auto;
				background: url(http://codegen.caihongy.cn/20240219/528c862fb88645a5ad02bbbcd4a1b273.png) repeat-y 32px center;
				width: auto;
				font-size: inherit;
				border-color: #ddd;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item {
				...
				border-radius: 0px !important;
				background: url(http://codegen.caihongy.cn/20240219/91ffa4dd788242dcbd06ac6fab194b99.png) no-repeat 32px center !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item {
				...
				line-height: 45px;
				border-radius: 0px;
				background: url(http://codegen.caihongy.cn/20240219/91ffa4dd788242dcbd06ac6fab194b99.png) no-repeat 32px center;
				width: auto;
				border-width: 0 0 0px;
				border-style: dashed;
				text-align: left;
